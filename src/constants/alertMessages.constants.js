export const alertMessages = {
    NEW_MEMBERSHIPS: {
        ...
        STARTDATE_NOT_VALID: { message: 'Start Date should not be over Expiry Date', severity:'info'}
    },

    EDIT_MEMBERSHIPS:{
        SUCCESS: { message: 'Update successfully', severity:'success'},
        FAILURE: { message: 'Update unsuccessfully', severity: 'error'},
        STARTDATE_NOT_VALID: { message: 'Start Date should not be over or same withExpiry Date', severity:'info'}
    },
}